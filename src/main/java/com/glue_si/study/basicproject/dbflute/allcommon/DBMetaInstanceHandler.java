package com.glue_si.study.basicproject.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("display_def_m", "com.glue_si.study.basicproject.dbflute.bsentity.dbmeta.DisplayDefMDbm");
        tmpMap.put("general_code_m", "com.glue_si.study.basicproject.dbflute.bsentity.dbmeta.GeneralCodeMDbm");
        tmpMap.put("system_property_m", "com.glue_si.study.basicproject.dbflute.bsentity.dbmeta.SystemPropertyMDbm");
        tmpMap.put("user_t", "com.glue_si.study.basicproject.dbflute.bsentity.dbmeta.UserTDbm");
